...
class Establish extends Component {
  ...
  onSubmit = () =>{
    ...
    const{logo,groupName,groupEnName,contactName,contactPhone,introduction,maxPerson} = this.state
    if(!logo){
...
export default Establish as ComponentClass<PageOwnProps, PageState>
